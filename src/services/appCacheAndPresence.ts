...
// Corriger le nom de la classe exportée
...
// export class UserPresenceService {
//   private redisClient: Redis | null = null;
//   private memoryCache: NodeCache = new NodeCache();
//   // private memoryCache: NodeCache;
//   private redisConnected: boolean = false;
...
// //           const matchedKeys = scanResult.keys;
...
// //           const prefixedKey = this.getCacheKey(key);
// //           const serializedValue = JSON.stringify(value);
// //           multi.setEx(prefixedKey, ttl, serializedValue);
// //         }
...
// //   try {
// //     if (this.redisConnected && this.redisClient) {
// //       let cursor = 0; // Redis v5 utilise number pour cursor
// //       const batchSize = 100;
// //       const deleteBatchSize = 50;
// //       let keysBuffer: string[] = [];
      
// //       do {
// //         // SCAN pour Redis v5 - syntaxe avec options object
// //         const scanResult = await this.redisClient.scan(cursor, {
// //           MATCH: prefixedPattern,
// //           COUNT: batchSize
// //         });
...
// //             // Pour Redis v5, DEL accepte un array mutable
// //             const mutableKeys = [...batchToDelete]; // Conversion en array mutable
// //             const deletedCount = await this.redisClient.del(mutableKeys);
...
// //       // Supprimer les clés restantes dans le buffer
// //       if (keysBuffer.length > 0) {
// //         const mutableKeys = [...keysBuffer]; // Conversion en array mutable
// //         const deletedCount = await this.redisClient.del(mutableKeys);
